...
if __name__ == '__main__':
    ...
    total_files = sorted(glob.glob("21g_T?_F_s.bag"))
    if not total_files:
        rospy.logerr("No files matching '21g_T?_F_s.bag' found.")
        sys.exit(1)
    ...
    topics = [
        ...
        '/cf4/thrust',
        '/cf4/F_s',
        '/cf1/acceleration_force',
        '/cf1/body_force',
        '/cf1/distance_scalar_force_rms',
        '/cf1/thrust',
        '/cf1/F_s'
    ]
    ...
    for inp in total_files:
        out = inp.replace('_F_s.bag', '_timestamp.bag')
        try:
