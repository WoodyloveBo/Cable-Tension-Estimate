...
if __name__ == '__main__':
    ...
    # 입력 파일 패턴: 9g_T1_total.bag ~ 9g_T5_total.bag
    total_files = sorted(glob.glob("20g_T?_index9_tension.bag"))
    if not total_files:
        rospy.logerr("No files matching '20g_T?_index9_tension.bag' found.")
        sys.exit(1)
    ...
    topics = [
        '/cf1/log1',
        '/cf2/log1',
        '/tension_gf/cf1/vector',
        '/tension_gf/cf2/vector'
    ]
    ...
    for inp in total_files:
        out = inp.replace('_index9_tension.bag', '_timestamp.bag')
        try:
